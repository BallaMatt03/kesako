<?php
	...
	function getProfilPhoto() {
		if (file_exists("../img/joueurs/".$_SESSION['login'].".jpg")){ 
			echo "../img/joueurs/".$_SESSION['login'].".jpg"; 
		} else { 
			echo "../img/joueurs/default.jpg";
		}
	}
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					?>
						<div class="pull-right">
							...
							<img style="max-height:35px;max-width:35px;" src="<?php getProfilPhoto(); ?>"/></a>
							</li>
